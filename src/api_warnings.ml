...
let add_error_to_piqi_warning_list base (w : M.Base_warnings.t) = function
  | Def.AlreadyDefined p ->
    { w with warning_already_defined =
               M.Warning_already_defined.{person = Api_util.person_to_warning_person base p }
               :: w.warning_already_defined }
  | OwnAncestor p ->
    { w with warning_own_ancestor =
               M.Warning_own_ancestor.{person = Api_util.person_to_warning_person base p }
               :: w.warning_own_ancestor }
  | BadSexOfMarriedPerson p ->
    { w with warning_bad_sex_of_married_person =
               M.Warning_bad_sex_of_married_person.{person = Api_util.person_to_warning_person base p }
...
let add_warning_to_piqi_warning_list conf base =
  ...
  fun (w : M.Base_warnings.t) (warn : Geneweb.Warning.base_warning) -> match warn with
